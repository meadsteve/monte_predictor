...
# The velocities for the previous 7 time periods (could be days, sprints, weeks etc.)
...
for sprints in [5, 6, 7, 8, 9, 10]:
    ...
    print(f"The chance of completion within {sprints} sprints is {complete_within * 100}")
